...
export default function GeneratePageContent({ initialResume, initialJd }: { initialResume?: any; initialJd?: string }) {
  const [jd, setJd] = useState(initialJd || '')
  const [descLength, setDescLength] = useState<'short' | 'long'>('short')
  const [jsonResume, setJsonResume] = useState<JsonResume | null>(initialResume || null)
          ...
          <div className="flex-1 p-4 flex flex-col gap-4 overflow-auto">
            ...
            <div>
              ...
              <Select value={descLength} onChange={(e) => setDescLength(e.target.value as 'short' | 'long')}>
                <option value="short">Short — 1-2 lines per role, grouped tech</option>
                <option value="long">Detailed — 5-6 bullets per role, full detail</option>
              </Select>
            </div>
